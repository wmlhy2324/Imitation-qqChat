...
const (
	...
	Social_FriendAndGroupSearch_FullMethodName = "/social.social/FriendAndGroupSearch"
)
...
type SocialClient interface {
	...
	// 搜索好友和群聊
	FriendAndGroupSearch(ctx context.Context, in *FriendAndGroupSearchReq, opts ...grpc.CallOption) (*FriendAndGroupSearchResp, error)
}
...
func (c *socialClient) FriendAndGroupSearch(ctx context.Context, in *FriendAndGroupSearchReq, opts ...grpc.CallOption) (*FriendAndGroupSearchResp, error) {
	out := new(FriendAndGroupSearchResp)
	err := c.cc.Invoke(ctx, Social_FriendAndGroupSearch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SocialServer interface {
	...
	// 搜索好友和群聊
	FriendAndGroupSearch(context.Context, *FriendAndGroupSearchReq) (*FriendAndGroupSearchResp, error)
...
func (UnimplementedSocialServer) FriendAndGroupSearch(context.Context, *FriendAndGroupSearchReq) (*FriendAndGroupSearchResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FriendAndGroupSearch not implemented")
}
...
func _Social_FriendAndGroupSearch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FriendAndGroupSearchReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SocialServer).FriendAndGroupSearch(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Social_FriendAndGroupSearch_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SocialServer).FriendAndGroupSearch(ctx, req.(*FriendAndGroupSearchReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Social_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FriendAndGroupSearch",
			Handler:    _Social_FriendAndGroupSearch_Handler,
		},
	},
