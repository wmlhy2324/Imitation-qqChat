...
type (
	...
	SearchFriendInfo         = social.SearchFriendInfo
	SearchGroupInfo          = social.SearchGroupInfo
...
// 搜索好友和群聊
func (m *defaultSocial) FriendAndGroupSearch(ctx context.Context, in *FriendAndGroupSearchReq, opts ...grpc.CallOption) (*FriendAndGroupSearchResp, error) {
	client := social.NewSocialClient(m.cli.Conn())
	return client.FriendAndGroupSearch(ctx, in, opts...)
}
