...
// 搜索好友和群聊
func (s *SocialServer) FriendAndGroupSearch(ctx context.Context, in *social.FriendAndGroupSearchReq) (*social.FriendAndGroupSearchResp, error) {
	l := logic.NewFriendAndGroupSearchLogic(ctx, s.svcCtx)
	return l.FriendAndGroupSearch(in)
}
